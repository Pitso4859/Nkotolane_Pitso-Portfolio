...
• JWT-secured multi-user access with role separation`,
  ...
  },
  {
    ...
    description: 'Full-stack clinic management platform for the VUT Health Clinic with appointment booking, live slot availability, and role-based access.',
    detailedDescription: `Mavuti Health is a production-grade clinic management platform built for the Vaal University of Technology Health Clinic, handling appointment booking for students, employees, and admins.
...
• Deployed with Docker and GitHub Actions CI/CD on Render`,
    stack: ['Spring Boot 3', 'Java 21', 'React 19', 'Vite', 'PostgreSQL', 'Redis', 'Docker', 'JWT'],
    features: [
      'JWT authentication with role-based access',
      'Live slot availability & booking validation',
      'Redis caching & async email notifications',
      'Docker + GitHub Actions CI/CD on Render',
    ],
    role: 'Full-Stack Developer - Architected the Spring Boot backend and React frontend, implemented booking logic and slot capacity management, and set up Docker/CI-CD deployment.',
