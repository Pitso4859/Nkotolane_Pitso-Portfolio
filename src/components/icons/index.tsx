...
export type PortfolioIcon = ComponentType<IconProps>;
...
export function Brain(props: IconProps) {
  return (
    <svg
      ...
      {...props}
    >
      <path d="M12 4a4 4 0 0 1 4 4c0 1.5-.5 3-1 4.5" />
      <path d="M8 8a4 4 0 0 1 2.5-3.7" />
      <path d="M16 12c0 2-1 3.5-2 5-1 1.5-1 3-1 5" />
      <path d="M12 12c-1 0-2 1-3 2-1 1-2 2-2 4" />
      <path d="M6 12c0-1 .5-2 1-3" />
    </svg>
  );
}
...
export function Lightbulb(props: IconProps) {
  return (
    ...
    >
      ...
      <path d="M10 22h4" />
      <path d="M12 2v4" />
      <path d="M12 6c-3 0-6 2-6 6 0 2.5 1.5 5 3 6v2h6v-2c1.5-1 3-3.5 3-6 0-4-3-6-6-6z" />
    </svg>
  );
}
