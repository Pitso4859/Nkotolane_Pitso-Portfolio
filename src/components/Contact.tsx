      ...
      <div className="grid gap-10 lg:grid-cols-[0.82fr_1.18fr] lg:gap-14">
        <div>
          ...
          <dl className="mt-7 divide-y divide-[#e6e8eb] border-y border-[#e6e8eb] dark:divide-[#29323f] dark:border-[#29323f]">
            <div className="flex min-w-0 items-center gap-3 py-3.5"><PictureIcon surface="transparent" src="/icon-logo/email_logo.png" size="lg" /><div className="min-w-0"><dt className="text-xs text-[#858e9a] dark:text-zinc-500">Email</dt><dd><a href="mailto:pnkotolane@gmail.com" className="break-all text-sm font-medium text-[#172033] hover:underline dark:text-white sm:break-normal">pnkotolane@gmail.com</a></dd></div></div>
            <div className="flex min-w-0 items-center gap-3 py-3.5"><PictureIcon surface="transparent" src="/icon-logo/phone_logo.png" size="lg" /><div className="min-w-0"><dt className="text-xs text-[#858e9a] dark:text-zinc-500">Phone</dt><dd><a href="tel:+27638654343" className="text-sm font-medium text-[#172033] hover:underline dark:text-white">+27 63 865 4343</a></dd></div></div>
            <div className="flex min-w-0 items-center gap-3 py-3.5"><PictureIcon surface="transparent" src="/icon-logo/location_logo.png" size="lg" /><div className="min-w-0"><dt className="text-xs text-[#858e9a] dark:text-zinc-500">Location</dt><dd className="text-sm font-medium text-[#172033] dark:text-white">Johannesburg, South Africa</dd></div></div>
          </dl>
          ...
          <div className="mt-5"><PrimaryButton href="/Files/NKOTOLANE PITSO GINTOS RESUME.pdf" download="Pitso_Nkotolane_CV.pdf" className="w-full sm:w-auto"><PictureIcon surface="transparent" src="/icon-logo/download_logo.png" size="sm" className="shrink-0" /><span className="whitespace-nowrap">Download CV</span></PrimaryButton></div>
        </div>
